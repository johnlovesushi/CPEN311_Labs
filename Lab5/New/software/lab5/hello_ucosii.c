...
void init_background() { // INIT BACKGROUND
	...
	//empty room coordinate: h:647-800, v:0-200
	//draw a face here
	vid_draw_circle(698, 66, 10, BLACK_24, 1, SW_Frame);
	vid_draw_circle(751, 66, 10, BLACK_24, 1, SW_Frame);
	vid_draw_circle(698, 68, 5, BLACK_24, 1, SW_Frame);
	vid_draw_circle(751, 68, 5, BLACK_24, 1, SW_Frame);
	vid_draw_line(693, 66, 703, 66, 4, WHITE_24, SW_Frame);
	vid_draw_line(746, 66, 756, 66, 4, WHITE_24, SW_Frame);
	vid_draw_line(718, 120, 723, 125, 4, WHITE_24, SW_Frame);
	vid_draw_line(723, 125, 728, 120, 4, WHITE_24, SW_Frame);
	vid_draw_line(718, 120, 728, 120, 4, WHITE_24, SW_Frame);

	//init lines
	//vid_draw_line(652, 234, 800, 234, 4, WHITE_24, SW_Frame);
	vid_draw_line(0, 407, 795, 407, 4, WHITE_24, SW_Frame);
	vid_draw_line(0, 598, 795, 598, 4, WHITE_24, SW_Frame);
	...
	vid_draw_line(261, 0, 795, 0, 4, WHITE_24, SW_Frame);
	vid_draw_line(647, 200, 795, 200, 4, WHITE_24, SW_Frame);	//NEW FRAME LINE

	draw_button(667, 215, 120, 35, 0x0066CC, "QPSK", 0, SW_Frame);	//CLICK BAR FOR QPSK
	...
	draw_button(667, 363, 120, 35, 0x0066CC, "LFSR", 0, SW_Frame);

	draw_button(667, 428, 120, 35, 0xCC6600, "SINE", 0, SW_Frame);
...
if (event == 1) {	//down event
	...
	if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 252
			&& y_mouse <= (252 + 35)) {
		draw_button(667, 215, 120, 35, 0x0066CC, "QPSK", 0, SW_Frame);
		draw_button(667, 252, 120, 35, 0x0066CC, "ASK", 1, SW_Frame);
		draw_button(667, 289, 120, 35, 0x0066CC, "FSK", 0, SW_Frame);
		draw_button(667, 326, 120, 35, 0x0066CC, "BPSK", 0, SW_Frame);
		draw_button(667, 363, 120, 35, 0x0066CC, "LFSR", 0, SW_Frame);
		...
		select_modulation(2);
	} else if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 363
			&& y_mouse <= (365 + 35)) {
		draw_button(667, 215, 120, 35, 0x0066CC, "QPSK", 0, SW_Frame);
		draw_button(667, 252, 120, 35, 0x0066CC, "ASK", 0, SW_Frame);
		draw_button(667, 289, 120, 35, 0x0066CC, "FSK", 0, SW_Frame);
		draw_button(667, 326, 120, 35, 0x0066CC, "BPSK", 0, SW_Frame);
		draw_button(667, 363, 120, 35, 0x0066CC, "LFSR", 1, SW_Frame);

		select_modulation(3);
	} else if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 215
			&& y_mouse <= (215 + 35)) {
		draw_button(667, 215, 120, 35, 0x0066CC, "QPSK", 1, SW_Frame);
		draw_button(667, 252, 120, 35, 0x0066CC, "ASK", 0, SW_Frame);
		draw_button(667, 289, 120, 35, 0x0066CC, "FSK", 0, SW_Frame);
		draw_button(667, 326, 120, 35, 0x0066CC, "BPSK", 0, SW_Frame);
		draw_button(667, 363, 120, 35, 0x0066CC, "LFSR", 0, SW_Frame);

		select_modulation(4);	//use select_modulation[2] to select qpsk
	}

	//Logic for the signal selector buttons
	if (x_mouse >= 667 && x_mouse <= (667 + 120) && y_mouse >= 428
			&& y_mouse <= (428 + 35)) {
		draw_button(667, 428, 120, 35, 0xCC6600, "SINE", 1, SW_Frame);
		draw_button(667, 470, 120, 35, 0xCC6600, "COS", 0, SW_Frame);
		draw_button(667, 512, 120, 35, 0xCC6600, "SAW", 0, SW_Frame);
	...
	if (x_mouse >= 296 && x_mouse <= (296 + play_up.width) && y_mouse >= 45
		...
		vid_draw_line(718, 120, 723, 125, 4, LIGHTSALMON_24, SW_Frame);
		vid_draw_line(723, 125, 728, 120, 4, LIGHTSALMON_24, SW_Frame);
		vid_draw_line(718, 120, 728, 120, 4, LIGHTSALMON_24, SW_Frame);
		vid_draw_circle(698, 66, 10, LIGHTSALMON_24, 1, SW_Frame);
		vid_draw_circle(751, 66, 10, LIGHTSALMON_24, 1, SW_Frame);
		vid_draw_circle(698, 68, 5, 0x60431D, 1, SW_Frame);
		vid_draw_circle(751, 68, 5, 0x60431D, 1, SW_Frame);
		...
		vid_draw_line(723, 125, 728, 120, 4, WHITE_24, SW_Frame);
		vid_draw_line(718, 120, 728, 120, 4, WHITE_24, SW_Frame);
		vid_draw_circle(698, 66, 10, WHITE_24, 1, SW_Frame);
		vid_draw_circle(751, 66, 10, WHITE_24, 1, SW_Frame);
		vid_draw_circle(698, 68, 5, BLACK_24, 1, SW_Frame);
		vid_draw_circle(751, 68, 5, BLACK_24, 1, SW_Frame);
		...
		vid_draw_line(718, 120, 723, 125, 4, LIGHTGREEN_24, SW_Frame);
		vid_draw_line(723, 125, 728, 120, 4, LIGHTGREEN_24, SW_Frame);
		vid_draw_line(718, 120, 728, 120, 4, LIGHTGREEN_24, SW_Frame);
		vid_draw_circle(698, 66, 10, LIGHTGREEN_24, 1, SW_Frame);
		vid_draw_circle(751, 66, 10, LIGHTGREEN_24, 1, SW_Frame);
		vid_draw_circle(698, 68, 5, BLACK_24, 1, SW_Frame);
		vid_draw_circle(751, 68, 5, BLACK_24, 1, SW_Frame);
